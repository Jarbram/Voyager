...
function VehicleIcon(): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      ...
      fill="none" style={{ color: V.vaultMid }}>
      <path
        d="M2 16 L2 12 L6 7 L9.5 5 L14.5 5 L18 7 L22 12 L22 16 Z"
        stroke="currentColor" strokeWidth="1.65"
        strokeLinecap="round" strokeLinejoin="round"
      />
      <circle cx="7" cy="16" r="2.5" stroke="currentColor" strokeWidth="1.65"/>
      <circle cx="17" cy="16" r="2.5" stroke="currentColor" strokeWidth="1.65"/>
      <path
        d="M8.5 7 L10 5 L14 5 L15.5 7"
